...
public class MailUtils {
	...
	public static void sendMail(String to,String code){
		...
		try {
			...
			// 正文:
			message.setContent("<h1>来自天虎官方商城的激活邮件:请点击下面链接激活!</h1><h3><a href='http://localhost:8888/store/user.do?method=active&code="+code+"'>http://localhost:8888/store/user.do?method=active&code="+code+"</a></h3>", "text/html;charset=UTF-8");
